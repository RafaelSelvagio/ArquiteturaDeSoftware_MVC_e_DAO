...
public class Main {
	public static void main(String[] args) {
		...
		while (opcao != 0) {
			...
			System.out.println("8. Testar conexão com o Banco de Dados"); // Nova funcionalidade
			...
			try {
				...
				case 8:
			        ...
			        boolean conexaoBemSucedida = teste.testarConexao();

			        if (conexaoBemSucedida) {
			            System.out.println("Conexão bem-sucedida. Você pode continuar com sua lógica de negócios aqui.");
			        } else {
